...
Route::middleware(['auth', 'super.admin', 'refresh.session'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('settings/notifications/template/save', [App\Http\Controllers\Admin\NotificationSettingsController::class, 'saveTemplates'])->name('admin.settings.notifications.template.save');
