        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('admin.templates.email.index') }}" class="btn btn-primary btn-sm me-2">
                            <i class="fas fa-envelope"></i> Email Templates
                        </a>
                        <a href="{{ route('admin.templates.sms.index') }}" class="btn btn-success btn-sm me-2">
                ...
                <div class="card-body">
                    ...
                    <!-- Notification Logs Section Removed - Now using separate Notification Logs page -->
...
// Inline Template Editing Functions (Removed - unused functionality)
