...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Default SMS templates are sent for certain events. You can create custom templates and assign them to specific events.</p>
        </div>
        <div>
            <a href="{{ route('admin.templates.sms.create') }}" class="btn btn-success">
                <i class="fas fa-plus"></i> Create New SMS Template
            </a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.templates.sms.edit', $template) }}" 
                                       class="btn btn-sm btn-outline-success" 
                                       title="Edit Template">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="{{ route('admin.templates.sms.show', $template) }}" 
                                       class="btn btn-sm btn-outline-info" 
                                       title="View Template">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <form action="{{ route('admin.templates.sms.toggle-status', $template) }}" 
