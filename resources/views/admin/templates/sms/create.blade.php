            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">
                                <i class="fas fa-plus text-success"></i> Create SMS Template
                            </h4>
                            <p class="card-subtitle text-muted">Create a new SMS template for notifications</p>
                        </div>
                        <div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.templates.sms.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('character_limit') is-invalid @enderror" 
                                               id="character_limit" name="character_limit" value="{{ old('character_limit', 160) }}" 
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" 
                                                   ...
                                                   {{ old('unicode_support', true) ? 'checked' : '' }}>
                        ...
                        <div class="template-group mb-4">
                            ...
                            <div class="form-group">
                                <label for="content" class="form-label">
                                    ...
                                    <span class="character-count text-muted ml-2">(<span id="char-count">0</span>/<span id="char-limit">160</span> characters)</span>
                                </label>
                                <textarea class="form-control @error('content') is-invalid @enderror" 
                                          id="content" name="content" rows="6" 
                                          placeholder="SMS Content" required maxlength="1000">{{ old('content') }}</textarea>
                                <small class="form-text text-muted">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-success btn-lg btn-block">
                                        <i class="fas fa-save"></i> Create SMS Template
                                    </button>
                                </div>
                                <div class="col-md-6">
