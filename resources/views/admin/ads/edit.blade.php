        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Ad: {{ $ad->title }}</h3>
                    <a href="{{ route('admin.ads.index') }}" class="btn btn-secondary float-end">
                        <i class="fas fa-arrow-left"></i> Back to Ads
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.ads.update', $ad) }}" method="POST" enctype="multipart/form-data" id="editAdForm">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            @enderror
                                            <div class="form-text">Title is optional. Ads will display as image-only banners.</div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Optional description for the ad">{{ old('description', $ad->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div class="form-text">Description is optional. Ads will display as image-only banners without text overlay.</div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('display_order') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('display_order', $ad->display_order) }}" 
                                                   min="0" step="1">
                                            @error('display_order')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="show_on_owner_dashboard" 
                                                       name="show_on_owner_dashboard" value="1" 
                                                       {{ old('show_on_owner_dashboard', $ad->show_on_owner_dashboard) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="show_on_tenant_dashboard" 
                                                       name="show_on_tenant_dashboard" value="1" 
                                                       {{ old('show_on_tenant_dashboard', $ad->show_on_tenant_dashboard) ? 'checked' : '' }}>
                                    ...
                                    <div class="card-body">
                                        <div class="row text-center">
                                            <div class="col-6">
                                                <div class="text-success">
                                                    <h4>{{ $ad->clicks_count }}</h4>
                                                    <small>Clicks</small>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="text-info">
                                                    <h4>{{ $ad->impressions_count }}</h4>
                                        ...
                                        <div class="mt-2 text-center">
                                            <small class="text-muted">
                                                Created: {{ $ad->created_at->format('M d, Y') }}<br>
                                                Updated: {{ $ad->updated_at->format('M d, Y') }}
                                            </small>
                                        </div>
                                    </div>
                                </div>
