        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add New Owner</h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.owners.index') }}" class="btn btn-secondary">
                            <i class="fas fa-arrow-left"></i> Back to Owners
                        </a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="alert alert-info">
                                    <strong>Note:</strong> A default password "password123" will be set for this owner.
