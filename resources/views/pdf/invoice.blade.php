    ...
    <div class="invoice-container">
        ...
        <div class="info-section">
            ...
            <div class="right-info">
                ...
                <div class="info-group">
                    ...
                    <div class="info-value">{{ $unit['name'] ?? 'N/A' }}</div>
                </div>
                <div class="info-group">
                    <div class="info-label">Issue Date:</div>
                    <div class="info-value">{{ $invoice['issue_date'] ?? 'N/A' }}</div>
                </div>
                <div class="info-group">
                    <div class="info-label">Due Date:</div>
                    <div class="info-value">{{ $invoice['due_date'] ?? 'N/A' }}</div>
                </div>
                <div class="info-group">
        ...
        @if(!empty($invoice['breakdown']))
            <table class="breakdown-table">
                ...
                <tbody>
                    @foreach($invoice['breakdown'] as $fee)
                        <tr>
                            <td>{{ $fee['name'] ?? 'N/A' }}</td>
        ...
        <div class="total-section">
            ...
            @if(($invoice['paid_amount'] ?? 0) > 0)
                ...
                <div class="total-row">
                    ...
                    <span class="total-value">${{ number_format($invoice['remaining_amount'] ?? 0, 2) }}</span>
                </div>
            @endif
        </div>

        <div class="footer">
            <p>Generated on {{ $generated_at ?? now()->format('M d, Y \a\t g:i A') }}</p>
